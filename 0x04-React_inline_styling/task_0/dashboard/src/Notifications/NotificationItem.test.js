...
describe('NotificationItem component', () => {
  test('renders NotificationItem without crashing', () => {
    render(<NotificationItem id={1} type="default" value="Test notification" />);
  ...
  test('renders correct html from type="urgent" value="New..." props', () => {
    render(<NotificationItem id={1} type="urgent" value="New resume available" />);
  ...
  test('renders correct html from html="<strong></strong>" props', () => {
    render(<NotificationItem id={1} html={getLatestNotification()} type="urgent" />);
  ...
  test('calls markAsRead with the correct ID when clicked', () => {
    ...
    render(<NotificationItem id={1} type="default" value="Test notification" id={1} markAsRead={markAsReadMock} />);
